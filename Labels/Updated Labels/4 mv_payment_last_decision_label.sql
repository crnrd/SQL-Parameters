...
select distinct payment_label, count(*) from mv_payment_last_decision_label group by 1 order by 1 desc limit 50;
-- select * from mv_payment_last_decision_label order by 1 desc limit 50;
...
GRANT SELECT ON credit_card_capping TO analyst, application; 
