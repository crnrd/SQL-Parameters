...
when user_last_manual_decision = 'decline_fraud' then 'bad_user' -- should divide here into types
when user_last_manual_decision = 'decline_potential_fraud' and old_approved_payments > 1 then 'declined_but_approved_before_without_cb'
